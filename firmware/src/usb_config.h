...
static const uint8_t config_descriptor[ ] =
{
  ...
  // Bit 0 â€” Device handles call management itself:
  //  1 = device handles call management (e.g. call setup, termination, etc.)
  //  0 = host handles it
  // Bit 1 â€” Device can send/receive call management information over a Data Class interface:
